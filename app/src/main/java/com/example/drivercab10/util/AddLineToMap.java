...
// Drawing polyline in the Google Map for the i-th route
            try {
                ...
                if (markerPoints.size() == 1) {
                    mMap.addMarker(new MarkerOptions().position((LatLng) markerPoints.get(0)).icon(BitmapDescriptorFactory.fromResource(R.drawable.placeholder)));
                } else if (markerPoints.size() == 2) {
                    driverMarker = mMap.addMarker(new MarkerOptions().position((LatLng) markerPoints.get(1)).icon(BitmapDescriptorFactory.fromResource(R.drawable.placeholder)));
                }
            } finally {
