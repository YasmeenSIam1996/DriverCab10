...
public class ResponseCheckStatus {
    ...
    @SerializedName("data")
    private CheckStatus checkStatuses;

    public boolean isSuccess() {
        return success;
    }

    public CheckStatus getCheckStatuses() {
    ...
    public class CheckStatus implements Serializable {
        ...
        private int status_provider_id;
        private String status_provider_text;
        ...
        public int getStatus_provider_id() {
            return status_provider_id;
        }

        public String getStatus_provider_text() {
            return status_provider_text;
        }
    }
